package com.dreams.demo.store.gateway.responserewriting;
...
import static com.dreams.demo.store.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
