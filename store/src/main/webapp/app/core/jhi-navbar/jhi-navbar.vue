        ...
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/entity/product">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.product')">Product</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/product-category">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.productCategory')">ProductCategory</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/customer">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.customer')">Customer</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/product-order">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.productOrder')">ProductOrder</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/order-item">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.orderItem')">OrderItem</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/invoice">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.invoiceInvoice')">Invoice</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/shipment">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.invoiceShipment')">Shipment</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/notification">
                        <font-awesome-icon icon="asterisk" />
