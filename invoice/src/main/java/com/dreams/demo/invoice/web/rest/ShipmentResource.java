...
import com.dreams.demo.invoice.service.ShipmentService;
import com.dreams.demo.invoice.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.dreams.demo.invoice.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
public class ShipmentResource {
    ...
    public ResponseEntity<List<ShipmentDTO>> getAllShipments(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
